...
<body class="font-sans antialiased"> <!-- Primer contenedor --> <div class="div1">
    <div style="display: flex; align-items: center;">
    <!-- Logo de la página -->
    <img src="{{ asset('storage/img/th3codelogo.png') }}" alt="GestionaTI"
    ...
    <x-buttonapp style="display: flex; align-items: center;" class="mt-8 w-56 mx-auto justify-center bg-teal-600 h-20">
    {{ __('Candidatos') }}
    </x-buttonapp>
    ...
    <x-buttonapp style="display: flex; align-items: center;" class="mt-4 w-56 mx-auto justify-center bg-teal-600 h-20">
        ...
        <x-buttonapp style="display: flex; align-items: center;"
            class="mt-4 w-56 mx-auto justify-center bg-teal-600 h-20">
            {{ __('Vacantes') }}
        </x-buttonapp>
        </div>
        <!-- Segundo contenedor -->
